...
# A:0
set_property LOC A13 [get_ports {A}]
set_property IOSTANDARD LVCMOS33 [get_ports {A}]

# B:0
set_property LOC A15 [get_ports {B}]
set_property IOSTANDARD LVCMOS33 [get_ports {B}]

# C:0
set_property LOC B16 [get_ports {C}]
set_property IOSTANDARD LVCMOS33 [get_ports {C}]

# D:0
set_property LOC B18 [get_ports {D}]
set_property IOSTANDARD LVCMOS33 [get_ports {D}]

# A1:0
set_property LOC H4 [get_ports {A1}]
set_property IOSTANDARD LVCMOS33 [get_ports {A1}]

# B1:0
set_property LOC H1 [get_ports {B1}]
...
# D1:0
set_property LOC G3 [get_ports {D1}]
set_property IOSTANDARD LVCMOS33 [get_ports {D1}]

# entrada:0
set_property LOC G6 [get_ports {entrada}]
set_property IOSTANDARD LVCMOS33 [get_ports {entrada}]

# entrada1:0
set_property LOC E6 [get_ports {entrada1}]
set_property IOSTANDARD LVCMOS33 [get_ports {entrada1}]

# entrada2:0
set_property LOC J3 [get_ports {entrada2}]
set_property IOSTANDARD LVCMOS33 [get_ports {entrada2}]
