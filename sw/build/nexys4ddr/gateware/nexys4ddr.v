//--------------------------------------------------------------------------------
// Auto-generated by Migen (a5cc037) & LiteX (32989c17) on 2020-12-17 20:00:59
//--------------------------------------------------------------------------------
module nexys4ddr(
...
wire [1:0] basesoc_color_status;
wire basesoc_color_we;
wire basesoc_color_re;
wire [1:0] basesoc_figure_status;
wire basesoc_figure_we;
wire basesoc_figure_re;
wire basesoc_done_status;
wire basesoc_done_we;
wire basesoc_done_re;
reg basesoc_init_procesamiento_storage = 1'd0;
reg basesoc_init_procesamiento_re = 1'd0;
wire basesoc_irq;
wire basesoc_ok_status;
reg basesoc_ok_pending = 1'd0;
reg basesoc_ok_trigger = 1'd0;
reg basesoc_ok_clear = 1'd0;
reg basesoc_ok_old_trigger = 1'd0;
...
wire [15:0] basesoc_distance_status;
wire basesoc_distance_we;
wire basesoc_distance_re;
reg [1:0] basesoc_boton_cambiar_grados_storage = 2'd0;
reg basesoc_boton_cambiar_grados_re = 1'd0;
reg basesoc_ultra_storage = 1'd0;
reg basesoc_ultra_re = 1'd0;
reg [1:0] basesoc_direccion_storage = 2'd0;
reg basesoc_direccion_re = 1'd0;
reg [1:0] basesoc_direccion2_storage = 2'd0;
reg basesoc_direccion2_re = 1'd0;
wire basesoc_salida_status;
wire basesoc_salida_we;
wire basesoc_salida_re;
wire basesoc_salida1_status;
wire basesoc_salida1_we;
wire basesoc_salida1_re;
wire basesoc_salida2_status;
wire basesoc_salida2_we;
wire basesoc_salida2_re;
...
wire builder_csrbank1_color_re;
wire [1:0] builder_csrbank1_color_r;
wire builder_csrbank1_color_we;
wire [1:0] builder_csrbank1_color_w;
wire builder_csrbank1_figure_re;
wire [1:0] builder_csrbank1_figure_r;
wire builder_csrbank1_figure_we;
...
wire builder_csrbank1_init_procesamiento0_re;
wire builder_csrbank1_init_procesamiento0_r;
wire builder_csrbank1_init_procesamiento0_we;
...
wire builder_csrbank4_salida_re;
wire builder_csrbank4_salida_r;
wire builder_csrbank4_salida_we;
wire builder_csrbank4_salida_w;
wire builder_csrbank4_salida1_re;
wire builder_csrbank4_salida1_r;
wire builder_csrbank4_salida1_we;
wire builder_csrbank4_salida1_w;
wire builder_csrbank4_salida2_re;
wire builder_csrbank4_salida2_r;
wire builder_csrbank4_salida2_we;
wire builder_csrbank4_salida2_w;
...
wire builder_csrbank5_out0_re;
wire [9:0] builder_csrbank5_out0_r;
wire builder_csrbank5_out0_we;
wire [9:0] builder_csrbank5_out0_w;
...
wire builder_csrbank6_direccion0_re;
wire [1:0] builder_csrbank6_direccion0_r;
wire builder_csrbank6_direccion0_we;
wire [1:0] builder_csrbank6_direccion0_w;
wire builder_csrbank6_direccion20_re;
wire [1:0] builder_csrbank6_direccion20_r;
wire builder_csrbank6_direccion20_we;
wire [1:0] builder_csrbank6_direccion20_w;
...
wire builder_csrbank7_distance_re;
wire [15:0] builder_csrbank7_distance_r;
wire builder_csrbank7_distance_we;
wire [15:0] builder_csrbank7_distance_w;
wire builder_csrbank7_boton_cambiar_grados0_re;
wire [1:0] builder_csrbank7_boton_cambiar_grados0_r;
wire builder_csrbank7_boton_cambiar_grados0_we;
wire [1:0] builder_csrbank7_boton_cambiar_grados0_w;
wire builder_csrbank7_ultra0_re;
wire builder_csrbank7_ultra0_r;
wire builder_csrbank7_ultra0_we;
wire builder_csrbank7_ultra0_w;
...
assign basesoc_eventmanager_status_w = basesoc_ok_status;
always @(*) begin
	basesoc_ok_clear <= 1'd0;
	if ((basesoc_eventmanager_pending_re & basesoc_eventmanager_pending_r)) begin
		basesoc_ok_clear <= 1'd1;
	end
end
assign basesoc_eventmanager_pending_w = basesoc_ok_pending;
assign basesoc_irq = (basesoc_eventmanager_pending_w & basesoc_eventmanager_storage);
assign basesoc_ok_status = basesoc_ok_trigger;
always @(*) begin
...
assign builder_csrbank1_color_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[2:0] == 1'd0));
assign builder_csrbank1_color_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[2:0] == 1'd0));
assign builder_csrbank1_figure_r = builder_interface1_bank_bus_dat_w[1:0];
assign builder_csrbank1_figure_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[2:0] == 1'd1));
assign builder_csrbank1_figure_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[2:0] == 1'd1));
assign builder_csrbank1_done_r = builder_interface1_bank_bus_dat_w[0];
assign builder_csrbank1_done_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[2:0] == 2'd2));
assign builder_csrbank1_done_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[2:0] == 2'd2));
assign builder_csrbank1_init_procesamiento0_r = builder_interface1_bank_bus_dat_w[0];
assign builder_csrbank1_init_procesamiento0_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[2:0] == 2'd3));
assign builder_csrbank1_init_procesamiento0_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[2:0] == 2'd3));
assign basesoc_eventmanager_status_r = builder_interface1_bank_bus_dat_w[0];
assign basesoc_eventmanager_status_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[2:0] == 3'd4));
assign basesoc_eventmanager_status_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[2:0] == 3'd4));
assign basesoc_eventmanager_pending_r = builder_interface1_bank_bus_dat_w[0];
assign basesoc_eventmanager_pending_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[2:0] == 3'd5));
assign basesoc_eventmanager_pending_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[2:0] == 3'd5));
assign builder_csrbank1_ev_enable0_r = builder_interface1_bank_bus_dat_w[0];
assign builder_csrbank1_ev_enable0_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[2:0] == 3'd6));
assign builder_csrbank1_ev_enable0_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[2:0] == 3'd6));
assign builder_csrbank1_color_w = basesoc_color_status[1:0];
assign basesoc_color_we = builder_csrbank1_color_we;
assign basesoc_color_re = builder_csrbank1_color_re;
assign builder_csrbank1_figure_w = basesoc_figure_status[1:0];
assign basesoc_figure_we = builder_csrbank1_figure_we;
assign basesoc_figure_re = builder_csrbank1_figure_re;
assign builder_csrbank1_done_w = basesoc_done_status;
assign basesoc_done_we = builder_csrbank1_done_we;
assign basesoc_done_re = builder_csrbank1_done_re;
assign builder_csrbank1_init_procesamiento0_w = basesoc_init_procesamiento_storage;
assign builder_csrbank1_ev_enable0_w = basesoc_eventmanager_storage;
...
assign builder_csrbank4_salida_r = builder_interface4_bank_bus_dat_w[0];
assign builder_csrbank4_salida_re = ((builder_csrbank4_sel & builder_interface4_bank_bus_we) & (builder_interface4_bank_bus_adr[1:0] == 1'd0));
assign builder_csrbank4_salida_we = ((builder_csrbank4_sel & (~builder_interface4_bank_bus_we)) & (builder_interface4_bank_bus_adr[1:0] == 1'd0));
assign builder_csrbank4_salida1_r = builder_interface4_bank_bus_dat_w[0];
assign builder_csrbank4_salida1_re = ((builder_csrbank4_sel & builder_interface4_bank_bus_we) & (builder_interface4_bank_bus_adr[1:0] == 1'd1));
assign builder_csrbank4_salida1_we = ((builder_csrbank4_sel & (~builder_interface4_bank_bus_we)) & (builder_interface4_bank_bus_adr[1:0] == 1'd1));
assign builder_csrbank4_salida2_r = builder_interface4_bank_bus_dat_w[0];
assign builder_csrbank4_salida2_re = ((builder_csrbank4_sel & builder_interface4_bank_bus_we) & (builder_interface4_bank_bus_adr[1:0] == 2'd2));
assign builder_csrbank4_salida2_we = ((builder_csrbank4_sel & (~builder_interface4_bank_bus_we)) & (builder_interface4_bank_bus_adr[1:0] == 2'd2));
assign builder_csrbank4_salida_w = basesoc_salida_status;
assign basesoc_salida_we = builder_csrbank4_salida_we;
assign basesoc_salida_re = builder_csrbank4_salida_re;
assign builder_csrbank4_salida1_w = basesoc_salida1_status;
assign basesoc_salida1_we = builder_csrbank4_salida1_we;
assign basesoc_salida1_re = builder_csrbank4_salida1_re;
assign builder_csrbank4_salida2_w = basesoc_salida2_status;
assign basesoc_salida2_we = builder_csrbank4_salida2_we;
assign basesoc_salida2_re = builder_csrbank4_salida2_re;
assign builder_csrbank5_sel = (builder_interface5_bank_bus_adr[13:9] == 3'd5);
assign builder_csrbank5_out0_r = builder_interface5_bank_bus_dat_w[9:0];
assign builder_csrbank5_out0_re = ((builder_csrbank5_sel & builder_interface5_bank_bus_we) & (builder_interface5_bank_bus_adr[0] == 1'd0));
assign builder_csrbank5_out0_we = ((builder_csrbank5_sel & (~builder_interface5_bank_bus_we)) & (builder_interface5_bank_bus_adr[0] == 1'd0));
assign builder_csrbank5_out0_w = basesoc_leds_storage[9:0];
assign builder_csrbank6_sel = (builder_interface6_bank_bus_adr[13:9] == 4'd11);
assign builder_csrbank6_direccion0_r = builder_interface6_bank_bus_dat_w[1:0];
assign builder_csrbank6_direccion0_re = ((builder_csrbank6_sel & builder_interface6_bank_bus_we) & (builder_interface6_bank_bus_adr[0] == 1'd0));
assign builder_csrbank6_direccion0_we = ((builder_csrbank6_sel & (~builder_interface6_bank_bus_we)) & (builder_interface6_bank_bus_adr[0] == 1'd0));
assign builder_csrbank6_direccion20_r = builder_interface6_bank_bus_dat_w[1:0];
assign builder_csrbank6_direccion20_re = ((builder_csrbank6_sel & builder_interface6_bank_bus_we) & (builder_interface6_bank_bus_adr[0] == 1'd1));
assign builder_csrbank6_direccion20_we = ((builder_csrbank6_sel & (~builder_interface6_bank_bus_we)) & (builder_interface6_bank_bus_adr[0] == 1'd1));
assign builder_csrbank6_direccion0_w = basesoc_direccion_storage[1:0];
assign builder_csrbank6_direccion20_w = basesoc_direccion2_storage[1:0];
assign builder_csrbank7_sel = (builder_interface7_bank_bus_adr[13:9] == 4'd10);
assign builder_csrbank7_distance_r = builder_interface7_bank_bus_dat_w[15:0];
assign builder_csrbank7_distance_re = ((builder_csrbank7_sel & builder_interface7_bank_bus_we) & (builder_interface7_bank_bus_adr[1:0] == 1'd0));
assign builder_csrbank7_distance_we = ((builder_csrbank7_sel & (~builder_interface7_bank_bus_we)) & (builder_interface7_bank_bus_adr[1:0] == 1'd0));
assign builder_csrbank7_boton_cambiar_grados0_r = builder_interface7_bank_bus_dat_w[1:0];
assign builder_csrbank7_boton_cambiar_grados0_re = ((builder_csrbank7_sel & builder_interface7_bank_bus_we) & (builder_interface7_bank_bus_adr[1:0] == 1'd1));
assign builder_csrbank7_boton_cambiar_grados0_we = ((builder_csrbank7_sel & (~builder_interface7_bank_bus_we)) & (builder_interface7_bank_bus_adr[1:0] == 1'd1));
assign builder_csrbank7_ultra0_r = builder_interface7_bank_bus_dat_w[0];
assign builder_csrbank7_ultra0_re = ((builder_csrbank7_sel & builder_interface7_bank_bus_we) & (builder_interface7_bank_bus_adr[1:0] == 2'd2));
assign builder_csrbank7_ultra0_we = ((builder_csrbank7_sel & (~builder_interface7_bank_bus_we)) & (builder_interface7_bank_bus_adr[1:0] == 2'd2));
assign builder_csrbank7_distance_w = basesoc_distance_status[15:0];
assign basesoc_distance_we = builder_csrbank7_distance_we;
assign basesoc_distance_re = builder_csrbank7_distance_re;
assign builder_csrbank7_boton_cambiar_grados0_w = basesoc_boton_cambiar_grados_storage[1:0];
assign builder_csrbank7_ultra0_w = basesoc_ultra_storage;
...
assign builder_csrbank11_sel = (builder_interface11_bank_bus_adr[13:9] == 2'd2);
...
assign builder_csrbank11_tuning_word0_w = basesoc_basesoc_storage[31:0];
...
always @(posedge sys_clk) begin
	...
	if (basesoc_ok_clear) begin
		basesoc_ok_pending <= 1'd0;
	end
	basesoc_ok_old_trigger <= basesoc_ok_trigger;
	if (((~basesoc_ok_trigger) & basesoc_ok_old_trigger)) begin
		basesoc_ok_pending <= 1'd1;
	end
	...
	if (builder_csrbank1_sel) begin
		case (builder_interface1_bank_bus_adr[2:0])
			...
			3'd4: begin
				builder_interface1_bank_bus_dat_r <= basesoc_eventmanager_status_w;
			end
			3'd5: begin
				builder_interface1_bank_bus_dat_r <= basesoc_eventmanager_pending_w;
			end
			3'd6: begin
	...
	if (builder_csrbank1_init_procesamiento0_re) begin
		basesoc_init_procesamiento_storage <= builder_csrbank1_init_procesamiento0_r;
	end
	basesoc_init_procesamiento_re <= builder_csrbank1_init_procesamiento0_re;
	if (builder_csrbank1_ev_enable0_re) begin
		basesoc_eventmanager_storage <= builder_csrbank1_ev_enable0_r;
	end
	basesoc_eventmanager_re <= builder_csrbank1_ev_enable0_re;
	...
	if (builder_csrbank4_sel) begin
		case (builder_interface4_bank_bus_adr[1:0])
			1'd0: begin
				builder_interface4_bank_bus_dat_r <= builder_csrbank4_salida_w;
			end
			1'd1: begin
				builder_interface4_bank_bus_dat_r <= builder_csrbank4_salida1_w;
			end
			2'd2: begin
				builder_interface4_bank_bus_dat_r <= builder_csrbank4_salida2_w;
			end
		endcase
	end
	...
	if (builder_csrbank5_out0_re) begin
		basesoc_leds_storage[9:0] <= builder_csrbank5_out0_r;
	end
	basesoc_leds_re <= builder_csrbank5_out0_re;
	builder_interface6_bank_bus_dat_r <= 1'd0;
	if (builder_csrbank6_sel) begin
		case (builder_interface6_bank_bus_adr[0])
			1'd0: begin
				builder_interface6_bank_bus_dat_r <= builder_csrbank6_direccion0_w;
			end
			1'd1: begin
				builder_interface6_bank_bus_dat_r <= builder_csrbank6_direccion20_w;
			end
		endcase
	end
	if (builder_csrbank6_direccion0_re) begin
		basesoc_direccion_storage[1:0] <= builder_csrbank6_direccion0_r;
	end
	basesoc_direccion_re <= builder_csrbank6_direccion0_re;
	if (builder_csrbank6_direccion20_re) begin
		basesoc_direccion2_storage[1:0] <= builder_csrbank6_direccion20_r;
	end
	basesoc_direccion2_re <= builder_csrbank6_direccion20_re;
	builder_interface7_bank_bus_dat_r <= 1'd0;
	if (builder_csrbank7_sel) begin
		case (builder_interface7_bank_bus_adr[1:0])
			1'd0: begin
				builder_interface7_bank_bus_dat_r <= builder_csrbank7_distance_w;
			end
			1'd1: begin
				builder_interface7_bank_bus_dat_r <= builder_csrbank7_boton_cambiar_grados0_w;
			end
			2'd2: begin
				builder_interface7_bank_bus_dat_r <= builder_csrbank7_ultra0_w;
			end
		endcase
	end
	if (builder_csrbank7_boton_cambiar_grados0_re) begin
		basesoc_boton_cambiar_grados_storage[1:0] <= builder_csrbank7_boton_cambiar_grados0_r;
	end
	basesoc_boton_cambiar_grados_re <= builder_csrbank7_boton_cambiar_grados0_re;
	if (builder_csrbank7_ultra0_re) begin
		basesoc_ultra_storage <= builder_csrbank7_ultra0_r;
	end
	basesoc_ultra_re <= builder_csrbank7_ultra0_re;
	...
	if (builder_csrbank11_tuning_word0_re) begin
		basesoc_basesoc_storage[31:0] <= builder_csrbank11_tuning_word0_r;
	end
	basesoc_basesoc_re <= builder_csrbank11_tuning_word0_re;
	if (sys_rst) begin
		...
		basesoc_init_procesamiento_storage <= 1'd0;
		basesoc_init_procesamiento_re <= 1'd0;
		basesoc_ok_pending <= 1'd0;
		basesoc_ok_old_trigger <= 1'd0;
		basesoc_eventmanager_storage <= 1'd0;
		basesoc_eventmanager_re <= 1'd0;
		basesoc_boton_cambiar_grados_storage <= 2'd0;
		basesoc_boton_cambiar_grados_re <= 1'd0;
		basesoc_ultra_storage <= 1'd0;
		basesoc_ultra_re <= 1'd0;
		basesoc_direccion_storage <= 2'd0;
		basesoc_direccion_re <= 1'd0;
		basesoc_direccion2_storage <= 2'd0;
		basesoc_direccion2_re <= 1'd0;
...
camara camara(
	...
	.CAM_vsync(cam_vsync),
	.clk(sys_clk),
	.init_procesamiento(basesoc_init_procesamiento_storage),
	.rst(sys_rst),
	.CAM_pwdn(cam_pwdn),
	.CAM_xclk(cam_xclk),
	...
	.VGA_Vsync_n(vsync),
	.color(basesoc_color_status),
	.done(basesoc_done_status),
	.figure(basesoc_figure_status)
);

radar radar(
	.boton_cambiar_grados(basesoc_boton_cambiar_grados_storage),
	.clk(sys_clk),
	.echo(echo),
	.ultra(basesoc_ultra_storage),
	.PWM(PWM),
	.distance(basesoc_distance_status),
	.done(done),
	.trigger(trigger)
);
...
motor motor(
	.clk(sys_clk),
	.direccion(basesoc_direccion_storage),
	.direccion2(basesoc_direccion2_storage),
	.rst(sys_rst),
	.A(A),
	.A1(A1),
	.B(B),
...
infra infra(
	...
	.entrada1(entrada1),
	.entrada2(entrada2),
	.salida(basesoc_salida_status),
	.salida1(basesoc_salida1_status),
	.salida2(basesoc_salida2_status)
);
